    ...
    <nav className="sticky flex gap-6 md:gap-10 p-4 justify-between z-50">
      ...
      <div className="flex flex-row gap-2 text-sm">
        {user ? (
          <>
            ...
            <AlertDialog open={openProfile}>
              <AlertDialogContent>
                ...
                <AlertDialogFooter>
                  <AlertDialogAction onClick={() => setOpenProfile(false)}>
                    Ok
                  </AlertDialogAction>
                </AlertDialogFooter>
              </AlertDialogContent>
          ...
          <>
            <Link href="/login">
              <button className="text-gray-100 hover:text-white font-bold py-2 px-4 bg-gray-800 hover:bg-gray-700 rounded-sm">
                Login
              </button>
            </Link>
            <Link href="/register">
