...
const FormSchema = z
  .object({
    username: z
      ...
      .regex(/^[_.+\-a-zA-Z0-9]+$/, {
        message:
          "Username must can only include letters, numbers, and _-+, can't use spaces",
      }),
  ...
  async function onSubmit(data: z.infer<typeof FormSchema>) {
    ...
    try {
      ...
      toast({
        ...
        description: (
          <div>
            Welcome to <b>Sunnylive!</b> Start by browsing current streams or
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                ...
                change this later. Remember, your username is your brand, keep
                it short and sweet!
              </FormDescription>
              <FormMessage />
            </FormItem>
